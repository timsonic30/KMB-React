...
function App() {
  ...
  const handleClick = async () => {
    ...
    if (cleanedRoute) {
      ...
      // console.log(correctRoute); // Why dose it always take the pervious value????????
  ...
  const handleDirectionClick = async (routeDetails) => {
    ...
    // setBound(routeDetails[1]);
    // setType(routeDetails[3]);
    // console.log(bound);
    // console.log(type);
    ...
    // for (let key in stationNameList) {
    //   console.log(stationNameList[key]);
    // }
  ...
  async function getStation(routeDetails) {
    ...
    for (let key in stopNameObject) {
      ...
      console.log("Here is ");
      // console.log("Stops:", stopName[key]);
    }
    return stopName;
  }
  ...
  // Why the object stationNameList can use map? -> it is an array of object
  ...
  async function findETA(stationName) {
    ...
    // console.log(stationName.ID);
    // console.log(stationName.Bound);
    // console.log(stationName.Type);
